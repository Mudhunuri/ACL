...
class Demographics(models.Model):
    ...
    sport = models.CharField(max_length=200, blank=True)
    current_activity = models.CharField(max_length=1000, blank=True)
    date_of_injury = models.DateField(null=True)
    knee = models.CharField(max_length=50, blank=True)
    mechanism_injury = models.CharField(max_length=1000, blank=True)
    other_injuries = models.CharField(max_length=4000, blank=True)
    ...
    planned_management = models.CharField(max_length=500,blank=True)
